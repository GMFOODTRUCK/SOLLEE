...
public class Foodtruck {
	...
	private	String	foodTruckTypenum; 
	private	String	foodTruckAddr;
	private	String	foodTruckOpen;
	private	String	foodTruckClose; 
	...
	public String getFoodTruckTypenum() {
		return foodTruckTypenum;
	}
	public void setFoodTruckTypenum(String foodTruckTypenum) {
	...
	public String getFoodTruckOpen() {
		return foodTruckOpen;
	}
	public void setFoodTruckOpen(String foodTruckOpen) {
		this.foodTruckOpen = foodTruckOpen;
	}
	public String getFoodTruckClose() {
		return foodTruckClose;
	}
	public void setFoodTruckClose(String foodTruckClose) {
